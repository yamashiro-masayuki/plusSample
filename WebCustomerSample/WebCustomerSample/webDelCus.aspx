...
<body>
    <form id="form1" runat="server">
        <div>
            <div>
                <p style="font-family: 'MS UI Gothic', 'ＭＳ Ｐゴシック', sans-serif; font-size: xx-large; width: 543px; height: 37px;">
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            ...
            <br />
                <div style="width: 890px">
                    <p style="font-family: 'MS UI Gothic', 'ＭＳ Ｐゴシック', sans-serif; font-size: medium; width: 657px; margin-top: 0px;">
                    ...
                    <asp:Panel ID="pnl_viewPanel" runat="server" BorderStyle="Double" Height="215px" Width="654px" Enabled="False">
                    <br />
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        <asp:Label ID="lbl_ID0" runat="server" Text="ID"></asp:Label>
                        &nbsp;&nbsp;
                        <asp:TextBox ID="txt_checkID" runat="server" MaxLength="6"></asp:TextBox>
                    <br />
                        &nbsp;　　&nbsp;&nbsp;&nbsp;<asp:Label ID="lbl_Pass0" runat="server" Text="Pass"></asp:Label>
                        &nbsp;&nbsp;<asp:TextBox ID="txt_checkPass" runat="server" MaxLength="10"></asp:TextBox>
                    <br />
